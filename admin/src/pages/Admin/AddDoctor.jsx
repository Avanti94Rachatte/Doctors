    ...
    <form onSubmit={onSubmitHandler} action="" className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 border w-full max-w-4xl max-h-[80vh] overflow-y-scroll ">
        <div className="flex items-center gap-4 mb-8 text-gray-500">
          ...
          <p className="">Uplod doctor <br />picture</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <div className="flex-1 flex flex-col gap-1">
              ...
              <input onChange={(e)=>setPassword(e.target.value)} value={password} type="password" placeholder='name' required className="border rounded px-3 py-2" />
            </div>
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            <div className="flex-1 flex flex-col gap-1">
              <p className="">Specility</p>
              <select onChange={(e)=>setSpeciality(e.target.value)} value={speciality} name="" id="" className="border rounded px-3 py-2">
                <option value="General physician" className="">General physician </option>
                <option value="Gynecologist" className="">Gynecologist</option>
                <option value="Dermatologist" className="">Dermatologist</option>
                <option value="Pediatricians" className="">Pediatricians</option>
                <option value="Neurologist" className="">Neurologist</option>
                <option value="Gastroenterologist" className="">Gastroenterologist</option>
              </select>
            </div>
